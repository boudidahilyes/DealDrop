 ...
 */
final class Version20240306231521 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE auction (id INT NOT NULL, highest_bid_id INT DEFAULT NULL, start_date DATETIME NOT NULL, current_price DOUBLE PRECISION NOT NULL, end_date DATETIME NOT NULL, UNIQUE INDEX UNIQ_DEE4F593AEB93B9F (highest_bid_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE bid (id INT AUTO_INCREMENT NOT NULL, bidder_id INT DEFAULT NULL, auction_id INT DEFAULT NULL, bid_date DATETIME DEFAULT NULL, value DOUBLE PRECISION NOT NULL, state VARCHAR(255) DEFAULT NULL, INDEX IDX_4AF2B3F3BE40AFAE (bidder_id), INDEX IDX_4AF2B3F357B8F0DE (auction_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, cin INT NOT NULL, adress VARCHAR(255) NOT NULL, phone INT NOT NULL, auth_code VARCHAR(255) DEFAULT NULL, reset_token VARCHAR(255) DEFAULT NULL, is_verified TINYINT(1) NOT NULL, birth_date DATETIME NOT NULL, joining_date DATETIME DEFAULT NULL, type VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, cin INT DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, phone INT DEFAULT NULL, is_verified TINYINT(1) NOT NULL, birth_date DATETIME NOT NULL, joining_date DATETIME NOT NULL, reset_token VARCHAR(255) DEFAULT NULL, auth_code VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_1483A5E9E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

 ...
 */
final class Version20240305145058 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE auction (id INT NOT NULL, start_date DATETIME NOT NULL, current_price DOUBLE PRECISION NOT NULL, end_date DATETIME NOT NULL, highest_bid INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

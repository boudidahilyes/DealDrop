 ...
 */
final class Version20240305111049 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE chat (id INT AUTO_INCREMENT NOT NULL, offer_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_659DF2AA53C674EE (offer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

 ...
 */
final class Version20240214190003 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, delivery_man_id INT DEFAULT NULL, product_id INT DEFAULT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, modify_date DATETIME DEFAULT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_C53D045FFD128646 (delivery_man_id), INDEX IDX_C53D045F4584665A (product_id), INDEX IDX_C53D045FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

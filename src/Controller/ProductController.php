...
class ProductController extends AbstractController
{
    ...
    #[Route('/homeDashboard/categories/{id}',defaults:['id'=>null], name: 'app_categories')]
    public function listCategory(ProductCategoryRepository $productCategory, Request $req,$id): Response
    {
